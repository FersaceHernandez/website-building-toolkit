...
The workspace audit found the following website-building surfaces:

| Surface | What it contains | Public treatment |
| --- | --- | --- |
...
The public repository is a reusable toolkit, not a mirror of the private workspace.
